...
export class Web3Enabled {
  ...
  constructor(public web3: Web3) {
    this.blocknativeAPIKey = 'c96aaa1c-ebc0-4671-9235-a9d21054a2a9';
    this.infuraKey = '376f051255db444596b482dbf36e186c';
    this.portisAPIKey = 'aa55d821-e417-495b-9e89-a5e2087337d4';
